...
namespace Nistec.Data.Entities
{
    ...
    public interface IDbContext:IDisposable
    {
        ...
        /// <param name="keyValueParameters"></param>
        /// <returns></returns>
        IList<T> EntityQuery<T>(string mappingName, params object[] keyValueParameters) where T : IEntityItem;
    ...
    public class DbContext : IDbContext
    {
        ...
        /// <param name="keyValueParameters"></param>
        /// <returns></returns>
        public IList<T> EntityQuery<T>(string mappingName, params object[] keyValueParameters) where T : IEntityItem
        {
            ValidateConnection();
            if (mappingName == null)
            {
        ...
        public int EntityDelete(string mappingName, params object[] nameValueParameters)
        {
            ...
            {
                return cmd.ExecuteNonQuery(commandText, DataParameter.GetSql(nameValueParameters));
            }
        }
        #endregion
        ...
        public int ExecuteCommand(string commandText, CommandType commandType , params object[] nameValueParameters)
        {
            ...
            using (IDbCmd cmd = DbCmd())
            {
                return cmd.ExecuteNonQuery(commandText, DataParameter.GetSql(nameValueParameters), commandType);
            }
        }
        ...
        /// <param name="nameValueParameters"></param>
        /// <returns></returns>
        public DataSet ExecuteDataSet(string mappingName, params object[] nameValueParameters)
        {
            if (mappingName == null)
            {
                throw new ArgumentNullException("ExecuteDataSet.mappingName");
            }
            using (IDbCmd cmd = DbCmd())
            {
                return cmd.ExecuteCommand<DataSet>(mappingName, DataParameter.GetSql(nameValueParameters), CommandType.StoredProcedure);
            }
        }
        /// <summary>
        /// Executes Command and returns IDataReader.
