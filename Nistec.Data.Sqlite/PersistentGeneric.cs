...
namespace Nistec.Data.Sqlite
{
    public class PersistentGeneric<T> : PersistentDictionary<T, PersistTextItem>
    {
        ...
        public PersistentGeneric(DbLiteSettings settings)
            : base(settings)
        {

        }

        public PersistentGeneric(string name)
        ...
        protected override T DecompressValue(PersistTextItem value)
        {
            var val=UnZip(value.body);
            return JsonSerializer.Deserialize<T>(val);  
        }
        protected override PersistTextItem ToPersistItem(string key, T item)
        {
        ...
        protected override T FromPersistItem(PersistTextItem value)
        {
            return JsonSerializer.Deserialize<T>(value.body);
        }
        #endregion
